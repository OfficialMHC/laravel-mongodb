<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a class="bg-blue-600 hover:bg-blue-500 px-2.5 py-1.5 text-white rounded-lg flex items-center gap-2" href="{{ route('authors.create') }}">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                            ...
                            <tr class="bg-white dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="h-2.5 w-2.5 rounded-full {{ $author->status ? 'bg-green-500' : 'bg-red-500' }} mr-2"></div> 
                                        {{ $author->status ? 'Active' : 'Inactive' }}
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <a href="{{ route('authors.edit', [$author]) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                        ...
                                        <form action="{{ route('authors.destroy', [$author]) }}" method="POST" onsubmit="return confirm('Are you sure!')">
                                            @csrf
                                            @method('DELETE')
                                            <button class="mt-1">
                        ...
                        @empty
                            <tr class="bg-white dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td colspan="4" class="px-6 py-4 text-center font-semibold text-red-500">
                                    {{ __("No Authors Found!") }}
                                </td>
                            </tr>
                        @endforelse
                ...
                <div class="{{ $authors->hasPages() ? 'p-4' : '' }}">
